...
@interface SHIntro1ViewController ()
...
@implementation SHIntro1ViewController
...
- (void)viewDidLoad
{
    ...
    self.infoLabel.text = @"Start studying to track your study hours and let your classmates know you're studying";
    ...
    //topleft
    self.topLeftCircle = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"StartStudyIntro75.png"]];
    ...
    //topRight
    self.topRightCircle = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"HoursStudiedIntro.png"]];
    ...
    //bottomLeft
    self.bottomLeftCircle = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"OfflineIllustration75.png"]];
    ...
    //bottomRight
    self.bottomRightCircle = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"OnlineIllustration75.png"]];
    ...
    //topLeftLabel
    [self setUpLabel:self.topLeftLabel withReferenceCircle:self.topLeftCircle andTitle:@"START STUDYING" andColor: [UIColor huddleGreen]];
    [self setUpLabel:self.topRightLabel withReferenceCircle:self.topRightCircle andTitle:@"TOTAL HOURS STUDIED" andColor: [UIColor huddlePurple]];
    [self setUpLabel:self.bottomLeftLabel withReferenceCircle:self.bottomLeftCircle andTitle:@"STUDENT OFFLINE" andColor: [UIColor huddleSilver]];
    [self setUpLabel:self.bottomRightLabel withReferenceCircle:self.bottomRightCircle andTitle:@"STUDENT ONLINE" andColor: [UIColor huddleGreen]];
