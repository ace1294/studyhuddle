...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    //get the image
    PFFile* imageFile = [[PFUser currentUser] objectForKey:SHStudentImageKey];
    ...
    {
        self.avatarImage = [UIImage imageNamed:@"blank_avatar"];
    }
	...
	incomingBubbleImageView = [JSQMessagesBubbleImageFactory incomingMessageBubbleImageViewWithColor:[UIColor huddleOrange]];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    //UIImageView* imageView = [[UIImageView alloc]initWithImage:self.avatarImage];
	if (avatars[user.objectId] == nil)
	{
		//PFFile *filePicture = user[PF_USER_THUMBNAIL];
        PFFile *filePicture = user[SHStudentImageKey];
